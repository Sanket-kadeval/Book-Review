                ...
                <div class="row align-items-center">
                    <div class="col-lg-4 col-md-5">
                        <div class="b-logo">
                                ...
                                <h1 class="pt-2 font-weight-bolder" style=" font-family: 'Akronim';font-size: 50px;"><span style="color:#FF6F61; font-size:50px;">G</span>ood<span style="color:#FF6F61; font-size:50px;">B</span>ook</h1>
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark text-center">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="shawuser.php" class="nav-link nav-item">Show user</a>
